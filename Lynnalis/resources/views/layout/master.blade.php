...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head> 
        ...
        <title>Lynnali's About Us</title>
        ...
        <footer>
            <div class="container-fluid padding">
                <div class="row text-center">
                    <div class="col-md-4">
                        <h5>Socials</h5>
                        <pre class="socials"><a href="#"><i class="fab fa-instagram"></i></a>    <a href="#"><i class="fab fa-facebook"></i></a>    <a href="#"><i class="fab fa-whatsapp"></i></a></pre>
                    </div>
                    <div class="col-md-4">
